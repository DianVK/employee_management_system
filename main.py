...
lbldoj = Label(entries_frame, text="D.O.J", font=("Calibri", 16), bg="#16a085", fg="white")
...
txtAddress = Text(entries_frame, width=73, height=1, font=("Calibri", 16))
...
btnAdd = Button(btn_frame, command=add_employee, text="Add Details", width=15, font=("Calibri", 16, "bold"), fg="white",
                bg="#535c68", bd=0).grid(row=0, column=0)

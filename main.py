...
lbljob = Label(entries_frame, text="Job Title", font=("Calibri", 16), bg="#16a085", fg="white")
lbljob.grid(row=2, column=0, padx=10, pady=10, sticky="w")
txtJob = Entry(entries_frame, textvariable=job, font=("Calibri", 16), width=30)
txtJob.grid(row=2, column=1, padx=10, pady=10, sticky="w")
...
lblAddress = Label(entries_frame, text="Contact No", font=("Calibri", 16), bg="#16a085", fg="white")
...
def add_employee():
    if txtName.get() == "" or txtAge.get() == "" or txtAddress.get() == "" or txtContact.get() == "" or txtJob.get() == "" or txtEmail.get() == "" or comboGender.get() == "":
        messagebox.showerror("Error!", "Invalid Data!\nPlease fill all the details!")
        return
    db.insert(txtName.get(), txtAge.get(), txtAddress.get(), txtContact.get(), txtJob.get(), txtEmail.get(),
              comboGender.get())
...
tree_frame.place(x=0, y=340, width=1980, height=500)
style = ttk.Style()
style.configure("mystyle.Treeview", font=("Galibri", 14),
